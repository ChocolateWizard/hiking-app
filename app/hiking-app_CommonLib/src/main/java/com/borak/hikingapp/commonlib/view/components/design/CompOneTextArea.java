 ...
 * @author Despot
 */
public abstract class CompOneTextArea<ComponentType, ValidatorType> extends javax.swing.JPanel implements IComponent<ComponentType> {
    ...
    public CompOneTextArea(IValidator validator) {
        initComponents();
...
//        lblCaption.setPreferredSize(new Dimension(100, height));
    ...
    private void setTextArea() {
        ...
        //txtArea.setPreferredSize(new Dimension(200, 70));       
    }
...
//----------------------------INPUT----------------------------------------------
    ...
    public void setAllInputsSize(Integer[] width, Integer[] height) {
        ...
        if ((width != null && width.length > 0) && (height != null && height.length > 0)) {
            ...
            scrollPane.setPreferredSize(new Dimension(width[0], height[0]));
